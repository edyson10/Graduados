                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-4 col-form-label">Evento</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="evento" name="evento" placeholder="Ingrese el nombre del evento.">
                                </div>
                            </div>
                            <div class="form-group row">
